...
public final class WikiGen
{
	...
	public static void main(String[] args) throws Throwable
	{
		...
		c.printf("Welcome to WikiGen!%nThis utility will encrypt & store your usernames/passwords%n%n");
		...
		writeFiles(px, cx.doFinal(GSONP.gson.toJson(ul, GSONP.strMapT).getBytes("UTF-8")));
