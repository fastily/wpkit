...
public final class Toolbox
{
	 ...
	 */
	private static DateTimeFormatter YMD = DateTimeFormatter.ofPattern("yyyy MMMM dd");
	 ...
	 */
	private static DateTimeFormatter DMY = DateTimeFormatter.ofPattern("dd MMMM yyyy");
